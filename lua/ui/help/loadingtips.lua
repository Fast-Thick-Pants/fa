...
Tips = {
    ...
    "<LOC loadingtip_0002>Consider the placement of Energy Storage, if destroyed it explodes violently",
    ...
    "<LOC loadingtip_0006>It is most efficent to upgrade a Mass Extractor to T2 before adding adjacent Mass Storages",
    ...
    "<LOC loadingtip_0011>Nearby Loyalists can reprogram incoming tactical missiles and return them to the sender",
    "<LOC loadingtip_0012>The Monkeylord is exceptionally cheap for an experimental unit",
